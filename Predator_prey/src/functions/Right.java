...
public class Right extends GPNode implements EvalPrint{
	...
	public void eval(final EvolutionState state, 
		...
		//updates preys location when predator looks right. 
		updatePreysLocation(state, pred);
//		advancePreysLocationUpdate2(state,pred); // used this function for comparative analysis.
	}
	
	
	// advance prey functionality.
